...
If you prefere you can also create only data class and then create a dynamic mapper to use as argument for extension method, avoid implementation of mapper class.
